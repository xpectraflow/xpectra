# ==============================================================================
# XpectraFlow Premium Self-Hosting Installer (PowerShell — Windows)
# ==============================================================================
# This script will:
...
#   5. Boot the full XpectraFlow stack with docker compose
...
Write-Host ""
Write-Host "══════════════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host "         XpectraFlow Premium Self-Hosting Suite — Setup (Windows)     " -ForegroundColor Green -Bold
Write-Host "══════════════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
# ==============================================================================
Write-Host "[1/6] Checking for Docker..." -ForegroundColor Yellow -Bold
...
if (-not $DockerInstalled) {
    Write-Host ""
    Write-Host "  ✗ Docker is not installed on this machine." -ForegroundColor Red -Bold
    Write-Host ""
    Write-Host "  Docker is a free tool that packages apps so they run identically" -ForegroundColor Cyan
    Write-Host "  on any computer — it's how XpectraFlow runs all its services." -ForegroundColor Cyan
    Write-Host ""
    Write-Host "  ──────────────────────────────────────────────────────────────" -ForegroundColor DarkGray
    Write-Host "  → Install Docker Desktop for Windows:" -ForegroundColor Yellow -Bold
...
# ==============================================================================
Write-Host ""
Write-Host "[2/6] Checking that Docker is running..." -ForegroundColor Yellow -Bold
...
if (-not $DockerRunning) {
    Write-Host ""
    Write-Host "  ✗ Docker is installed but not currently running." -ForegroundColor Red -Bold
    Write-Host ""
...
if ([string]::IsNullOrEmpty($ComposeCmd)) {
    Write-Host ""
    Write-Host "  ✗ Docker Compose was not found." -ForegroundColor Red -Bold
    Write-Host ""
...
# ==============================================================================
Write-Host ""
Write-Host "[3/6] Configuring environment (.env)..." -ForegroundColor Yellow -Bold
...
# ==============================================================================
Write-Host ""
Write-Host "[4/6] Checking for local Python and Pip setup..." -ForegroundColor Yellow -Bold
...
# ==============================================================================
Write-Host ""
Write-Host "[5/6] Authenticating with the XpectraFlow container registry..." -ForegroundColor Yellow -Bold
...
if ($AlreadyAuth) {
    ...
    Write-Host ""
    Write-Host "  XpectraFlow images are hosted in a secure private registry." -ForegroundColor Cyan
    Write-Host "  Please enter your premium XpectraFlow License Code to authenticate." -ForegroundColor Cyan
    Write-Host ""

    $LicenseCode = Read-Host "  Enter your XpectraFlow License Code" -AsSecureString
    ...
    if ($LoginExitCode -eq 0) {
        ...
        Write-Host ""
        Write-Host "  ✗ Authentication failed." -ForegroundColor Red -Bold
...
# ==============================================================================
Write-Host ""
Write-Host "[6/6] Pulling images and booting XpectraFlow..." -ForegroundColor Yellow -Bold
...
Write-Host ""
Write-Host "══════════════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host "🎉 XpectraFlow is live!" -ForegroundColor Green -Bold
Write-Host "══════════════════════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Dashboard URL :  $DASHBOARD_URL" -ForegroundColor White -Bold
